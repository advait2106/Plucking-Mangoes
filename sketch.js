...
function preload(){
  ...
  thisImage.loadImage("images/boy.png");
  mango=loadImage("images/mango.png");
  thisImage=loadImage("images/mango.png");
  stone=loadImage("images/stone.png");
  thisImage=loadImage("images/stone.png");
  tree=loadImage("images/tree.png");
  thisImage=loadImage("images/tree.png");
...
function draw() {
  ...
  boy(isThrowing(stone));
  stone(isTouchingMango);
  Mango(isFalling);
